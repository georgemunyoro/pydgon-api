...
-- AddForeignKey
ALTER TABLE "Message" ADD CONSTRAINT "Message_recepientId_fkey" FOREIGN KEY ("recepientId") REFERENCES "User"("uuid") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Message" ADD CONSTRAINT "Message_replyToId_fkey" FOREIGN KEY ("replyToId") REFERENCES "Message"("uuid") ON DELETE RESTRICT ON UPDATE CASCADE;
